...
function editColour(cars, carColour, newColour) {
  ...
  for (let i = 0; i < cars.length; i++) {
    // If current car colour matches the value passed to the carColour parameter
    if (cars[i].colour === carColour) {
      // Update the colour property to the value passed to the newColour parameter
